  ...
  head: () => ({
    meta: [
      { title: "Help Center & Panduan — EcoGrant AI" },
      {
        name: "description",
        content:
          "Kumpulan panduan wizard 10 langkah, AI, LFA, SBM, SBU, RAB, FAQ, dan kontak dukungan.",
      },
    ],
  }),
  component: HelpPage,
...
function HelpPage() {
      ...
      const fallbackArticles = [
        {
          id: "h1",
          category: "Memulai",
          title: "Panduan Memulai EcoGrant AI",
          excerpt: "Langkah dasar menggunakan platform.",
          content:
        ...
        },
        {
          id: "h2",
          category: "Wizard",
          title: "10 Langkah Wizard Proposal",
          excerpt: "Penjelasan tahapan penyusunan proposal.",
          content:
            "Langkah 1: Informasi Proposal\nLangkah 2: Penyusunan Narasi\nLangkah 3: Executive Summary\nLangkah 4: Pemilihan Lembaga Donor\nLangkah 5: Logical Framework Matrix (LFA)\nLangkah 6: Sinkronisasi Standar Biaya Masukan (SBM)\nLangkah 7: Sinkronisasi Standar Biaya Umum (SBU)\nLangkah 8: Rencana Anggaran Biaya (RAB)\nLangkah 9: Review Proposal & Audit\nLangkah 10: Export Dokumen (Word/PDF/Excel)",
        },
        {
          id: "h3",
          category: "AI",
          title: "Cara Menggunakan AI Generator",
          excerpt: "Tips perintah prompt AI untuk hasil optimal.",
          content:
            "Klik tombol 'Generate dengan AI' pada setiap bagian narasi atau LFA. AI akan menganalisis latar belakang, indikator, dan kebutuhan donor untuk menghasilkan teks draft yang sesuai dengan standar penulisan hibah.",
        },
        {
          id: "h4",
          category: "LFA",
          title: "Panduan Logical Framework Analysis (LFA)",
          excerpt: "Penyusunan hirarki Goal, Outcome, Output, dan Activity.",
          content:
            "LFA menghubungkan tujuan program secara terstruktur. Pastikan Indikator Kinerja Utama (IKU) terukur dengan baseline, target, dan metode verifikasi (MoV) yang terpercaya.",
        },
        {
          id: "h5",
          category: "SBM",
          title: "Panduan Standar Biaya Masukan (SBM)",
          excerpt: "Validasi batasan harga masukan sesuai PMK.",
          content:
            "SBM digunakan untuk memvalidasi batas maksimum honorarium, perjalanan dinas, konsumsi, dan sewaan. Sistem akan menandai otomatis jika ada harga satuan melebihi batas SBM.",
        },
        {
          id: "h6",
          category: "SBU",
          title: "Panduan Standar Biaya Umum (SBU)",
          excerpt: "Penyesuaian standar biaya regional provinsi.",
          content:
            "SBU menyesuaikan standar harga akomodasi dan transportasi lokal berdasarkan kode wilayah provinsi/kabupaten lokasi pelaksanaan kegiatan.",
        },
        {
          id: "h7",
          category: "RAB",
          title: "Penyusunan Rencana Anggaran Biaya (RAB)",
          excerpt: "Perhitungan otomatis volume, frekuensi, dan pajak PPN.",
          content:
            "Setiap baris RAB dihubungkan dengan kegiatan LFA. Sistem akan otomatis menghitung subtotal, pajak PPN (11%), dan total anggaran proposal secara presisi.",
        },
        {
          id: "h8",
          category: "FAQ",
          title: "Pertanyaan yang Sering Diajukan (FAQ)",
          excerpt: "Jawaban atas pertanyaan umum seputar platform.",
          content:
            "Q: Apakah data proposal saya aman?\nA: Ya, seluruh data proposal terisolasi per organisasi/workspace dan dilindungi enkripsi RLS.\n\nQ: Format file apa saja yang didukung untuk ekspor?\nA: Anda dapat mengunduh proposal dalam format DOCX (Word), PDF, dan XLSX (Excel).",
        },
        {
          id: "h9",
          category: "Dukungan",
          title: "Kontak Layanan Dukungan Teknis",
          excerpt: "Hubungi tim bantuan jika mengalami kendala.",
          content:
            "Jika membutuhkan bantuan teknis atau menemukan kendala, silakan hubungi tim dukungan kami melalui email di dukungan@ecogrant.ai atau WhatsApp Hotline +62 812-3456-7890 (Senin - Jumat, 08:00 - 17:00 WIB).",
        },
      ];
  ...
  const filtered = data.filter((a) => {
    ...
    if (!term) return true;
    return [a.title, a.excerpt, a.content, a.category].some((f) =>
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <PageHeader
        ...
        description="Cari panduan penggunaan, tips AI, aturan SBM/SBU, dan jawaban pertanyaan umum."
      />
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Coba gunakan kata kunci pencarian lain atau hubungi tim dukungan kami di dukungan@ecogrant.ai."
        />
      ) : (
          ...
          {filtered.map((a) => (
            <AccordionItem key={a.id} value={a.id}>
              ...
              <AccordionContent className="pb-4 pt-1 text-sm leading-relaxed">
                {a.excerpt && (
                  <p className="mb-2 text-xs text-muted-foreground font-medium">{a.excerpt}</p>
                )}
