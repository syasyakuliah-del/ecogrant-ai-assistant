-- ============================================================================
-- Migration: Wizard Master Data & RPC Seed Function
-- Project: EcoGrant AI Assistant
-- ============================================================================

-- SECURITY DEFINER function allowing master data seeding
CREATE OR REPLACE FUNCTION public.seed_master_data()
RETURNS TEXT
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.seed_master_data() TO authenticated, anon;
